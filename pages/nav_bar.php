<!-- ============================================================== -->
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="#">3DH Code</a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" ><i class="fas fa-home"></i>Inicio <span class="badge badge-success">6</span></a> 
                            </li>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="/pages/employees.php">Empleados</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/pages/projects.php">Proyectos</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/pages/payments.php">Pagos</a>
                                        </li>
                                        <?php
